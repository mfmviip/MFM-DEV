...
if hash or Bot(msg) or DevTOKYO(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevTOKYO(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevTOKYO(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevTOKYO(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevTOKYO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevTOKYO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."TOKYO:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevTOKYO(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then  
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevTOKYO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevTOKYOe(user_id) == true then
var = true
elseif DevTOKYO(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(911945965) then  
var = 'مطور السورس'
elseif DevTOKYOe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
elseif database:sismember(bot_id.."TOKYO:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."Special:User"..chat_id, user_id) then  
...
function TOKYO_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local TOKYO_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if TOKYO_Msg then    
...
if text == ("الثانويين") and DevTOKYO(msg) then
...
if text == ("مسح قائمه العام") and DevTOKYO(msg) then
database:del(bot_id.."GBan:User")
database:del(bot_id.."Gmute:User")
send(msg.chat_id_, msg.id_, "\n*✘ ∫ تم مسح قائمه العام*")
return false
end
if text == ("مسح المطورين") and DevTOKYO(msg) then
...
if text == ("قائمه العام") and DevTOKYO(msg) then
...
if text == ("قائمه كتم عام") and DevTOKYO(msg) then
...
if text == ("المطورين") and DevTOKYO(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTOKYO(msg) then
function Function_TOKYO(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "*✘ ∫ سنفر لا يمكنك حظر المطور الاساسي* \n")
return false 
end
if result.sender_user_id_ == tonumber(911945965) then
...
if text and text:match("^حظر عام @(.*)$")  and DevTOKYO(msg) then
...
if result.id_ == tonumber(911945965) then
send(msg.chat_id_, msg.id_, "*✘ ∫ سنفر لا يمكنك حظر مطور السورس* \n")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevTOKYO(msg) then
local userid = text:match("^حظر عام (%d+)$")
if userid == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "*✘ ∫ سنفر لا يمكنك حظر المطور الاساسي* \n")
return false 
end
if userid == tonumber(911945965) then
send(msg.chat_id_, msg.id_, "*✘ ∫ سنفر لا يمكنك حظر مطور السورس* \n")
return false 
end
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTOKYO(msg) then
function Function_TOKYO(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
...
if text and text:match("^كتم عام @(.*)$")  and DevTOKYO(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevTOKYO(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTOKYO(msg) then
function Function_TOKYO(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTOKYO(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevTOKYO(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTOKYO(msg) then
function Function_TOKYO(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevTOKYO(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevTOKYO(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","✘ ∫ تم ترقيته مطور في البوت")  
return false 
end
if text == ("تنزيل مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTOKYO(msg) then
function Function_TOKYO(extra, result, success)
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTOKYO(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTOKYO(msg) then
...
local TOKYOrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if TOKYOrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✘ ∫ العضو ⏎ ["..data.first_name_.."](t.me/"..(data.username_ or "TOKYO_TEAM")..")".."\n✘ ∫ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif TOKYOrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"✘ ∫ العضو ⏎ ["..data.first_name_.."](t.me/"..(data.username_ or "TOKYO_TEAM")..")".."\n✘ ∫ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif TOKYOrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"✘ ∫ العضو ⏎ ["..data.first_name_.."](t.me/"..(data.username_ or "TOKYO_TEAM")..")".."\n✘ ∫ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif TOKYOrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✘ ∫ العضو ⏎ ["..data.first_name_.."](t.me/"..(data.username_ or "TOKYO_TEAM")..")".."\n✘ ∫ تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local TOKYOrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if TOKYOrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✘ ∫ العضو ⏎ ["..result.title_.."](t.me/"..(text1[3] or "TOKYO_TEAM")..")".."\n✘ ∫ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
usertext = '\n⋄ العضو > ['..result.title_..'](t.me/'..(username or 'TOKYO_TEAM')..')'
status  = '\n⋄ تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✘ ∫ العضو ⏎ ['..data.first_name_..'](t.me/'..(data.username_ or 'TOKYO')..') '
...
local list = database:smembers(bot_id.."TOKYO:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "*✘ ∫ تم مسح "..k.." من الوسائط الموجوده*"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."TOKYO:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."TOKYO:allM"..msg.chat_id_)
...
function Function_TOKYO(extra, result, success)
database:sadd(bot_id.."TOKYO:MN:TF"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","✘ ∫ تم ترقيته منظف للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = Owner(msg.reply_to_message_id_)}, Function_TOKYO, nil)
return false
end
...
database:sadd(bot_id.."TOKYO:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TOKYO:MN:TF"..msg.chat_id_, userid)
...
function Function_TOKYO(extra, result, success)
database:srem(bot_id.."TOKYO:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_TOKYO(extra, result, success)
if result.id_ then
database:srem(bot_id.."TOKYO:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TOKYO:MN:TF"..msg.chat_id_, userid)
...
database:del(bot_id.."TOKYO:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."TOKYO:MN:TF"..msg.chat_id_)
t = "\n*✘ ∫ قائمة المنظفين* \n*⊶─────≺⋆≻─────⊷*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TOKYO:User:Name" .. v)
if username then
t = t..""..k.."↬𖣸 [@"..username.."]\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevTOKYO(msg) then 
...
if text == ("ردود المطور") and DevTOKYO(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n*✘ ∫ قائمة ردود المطور* \n*⊶─────≺⋆≻─────⊷*\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevTOKYO(msg) then 
send(msg.chat_id_, msg.id_,"*✘ ∫ ارسل الكلمه التري تريد اضافتها*")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevTOKYO(msg) then 
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'TOKYO:Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_TOKYO(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
if text == "تفعيل المغادره" and DevTOKYO(msg) then   
database:del(bot_id.."Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"*✘ ∫ تم تفعيل مغادرة البوت*") 
return false 
end
if text == "تعطيل المغادره" and DevTOKYO(msg) then  
...
if database:get(bot_id.."Status:Bc") and not DevTOKYO(msg) then 
...
if text == "تفعيل الاذاعه" and DevTOKYO(msg) then  
database:del(bot_id.."Status:Bc") 
send(msg.chat_id_, msg.id_,"\n*✘ ∫ تم تفعيل الاذاعه *" ) 
return false
end 
if text == "تعطيل الاذاعه" and DevTOKYO(msg) then  
...
if text == "تنظيف المشتركين" and DevTOKYO(msg) then
...
if text == "تنظيف الكروبات" and DevTOKYO(msg) then
...
if text == ("تحديث السورس") and DevTOKYO(msg) then  
send(msg.chat_id_,msg.id_,'*✘ ∫ تم التحديث السورس بنجاح .*')
os.execute('rm -rf TOKYO.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/mfmvip/mfmvip/main/TOKYO.lua')
os.execute('wget https://raw.githubusercontent.com/mfmvip/mfmvip/main/start.lua')
dofile('TOKYO.lua')  
return false
end
if text == "راسلني" then
...
if text == 'السيرفر' and DevTOKYO(msg) then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- ᴛᴏᴋʏᴏsᴏᴜʀᴄᴇ .',url="t.me/TOKYO_TEAM"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جلب نسخه احتياطيه' and DevTOKYO(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if database:get(bot_id.."MFMVIP:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"*⋄ انتظر دقيقه من فضلك*")
end
database:setex(bot_id..'MFMVIP:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevTOKYO(msg) then
t = '*✘ ∫ جميع الملفات *\n*⊶─────≺⋆≻─────⊷*\n'
i = 0
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
...
if DevTOKYO(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/mfmvip/files_MER/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevTOKYO(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/mfmvip/files_MER/main/files_MER/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevTOKYO(msg) then
...
if text == "مسح جميع الملفات" and DevTOKYO(msg) then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"✘ ∫ تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevTOKYO(msg) then
...
if text == 'حذف كليشه المطور' and DevTOKYO(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'✘ ∫ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevTOKYO(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevTOKYO(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevTOKYO(msg) then
dofile("TOKYO.lua")  
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTOKYO(msg) then
...
if not DevTOKYO(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevTOKYO(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text and text:match("^تغير الاشتراك ⋄$") and DevTOKYO(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✘ ∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك ⋄$") and DevTOKYO(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✘ ∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⋄ ." and DevTOKYO(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "✘ ∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^تعين قناة الاشتراك ⋄$") and DevTOKYO(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✘ ∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⋄" and DevTOKYO(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⋄" and DevTOKYO(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "✘ ∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⋄" and DevTOKYO(msg) then  
...
if text == ("قائمه المكتومين العام ⋄") and DevTOKYO(msg) then
local list = database:smembers(bot_id.."Gmute:User")
...
os.execute('rm -rf TOKYO.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/mfmvip/TOKYO2/main/TOKYO.lua')
os.execute('wget https://raw.githubusercontent.com/mfmvip/TOKYO2/main/start.lua')
dofile('TOKYO.lua')  
return false
end
...
inline = {
{{text = '- sᴏᴜʀᴄᴇ ᴛᴏᴋʏᴏ .',url='http://t.me/TOKYO_TEAM'}},
}
...
------------------------------------------------------------------------
if text then
local TOKYO_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if TOKYO_Msg then    
